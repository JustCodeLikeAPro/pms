 ...
 * - Suggestions dropdown on username focus (click + keyboard accessible: Esc/↑/↓/Home/End/Enter)
 * - “Manage saved logins” modal (remove single / clear all)
...
export default function Login() {
  ...
  // Username input keyboard handler (combobox behavior)
      ...
      <main className="px-4 sm:px-6 lg:px-10 pb-16">
        <div className="mx-auto max-w-md">
          <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border dark:border-neutral-800 p-6 space-y-4">
            ...
            {step === 'enter' && (
              <>
                {/* Username + suggestions (keyboard accessible combobox) */}
                <div ref={inputWrapRef} className="relative">
                  <input
                    ...
                    onBlur={() => setTimeout(() => setShowSuggestions(false), 0)} // optional close on blur
                    autoFocus
                    autoComplete="off"
                    role="combobox"
